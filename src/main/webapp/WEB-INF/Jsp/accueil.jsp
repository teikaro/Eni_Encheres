            ...
            <form class="filtreForm" action="${pageContext.request.contextPath}/accueil" method="post" id="formradio" style="margin-top: 25px; position: relative; left: 320px;">
                ...
                <fieldset id="check" style="display: inline;">
                    ...
                    <div style="margin-left: 30px;">
                        <input type="checkbox" id="encheres_ouvertes" name="check" value="encheres_ouvertes"/>
                        <label for="encheres_ouvertes">Ouvertes</label>
                    </div>

                    <div style="margin-left: 30px;">
                        <input type="checkbox" id="mes_encheres_en_cours" name="check" value="mes_encheres_en_cours"/>
                        <label for="mes_encheres_en_cours">En cours</label>
                    </div>

                    <div style="margin-left: 30px;">
                        <input type="checkbox" id="mes_encheres_remportees" name="check" value="mes_encheres_remportees"/>
                ...
                <fieldset style="display: inline;">
                    ...
                    <div style="margin-left: 30px;">
                        <input type="checkbox" id="mes_ventes_en_cours" name="check" value="mes_ventes_en_cours"/>
                        <label for="mes_ventes_en_cours">En cours</label>
                    </div>

                    <div style="margin-left: 30px;">
                        <input type="checkbox" id="ventes_non_debutees" name="check" value="ventes_non_debutees"/>
                        <label for="ventes_non_debutees">Non débutées</label>
                    </div>

                    <div style="margin-left: 30px;">
                        <input type="checkbox" id="ventes_terminees" name="check" value="ventes_terminees"/>
